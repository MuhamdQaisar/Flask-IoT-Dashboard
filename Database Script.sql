...
values ('QaisarAhmad', md5('put ur pass'), 'Muhammad', 'Qaisar', 'engr.qahmad@gmail.com', '030000', now(), 'not-created-yet');
...
select * from Node;
select field_name, temperature, humidity, moisture, light from Node where username="QaisarAhmad";

insert into Node (deviceID, username, field_name, temperature, humidity, moisture, light)
values('ARMS12012', 'QaisarAhmad', 'Rose Garden', 45, 54, 100, 600);
-- insert into Node (deviceID, username, field_name, temperature, humidity, moisture, light)
